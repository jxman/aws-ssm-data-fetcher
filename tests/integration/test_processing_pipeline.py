...
def test_processing_pipeline():
    ...
    try:
        ...
        print(f"✅ Pipeline execution details: {execution['completed_stages']} stages completed")
        ...
        expected_stages = ['discovery', 'mapping', 'transformation', 'analysis', 'validation', 'output']
        ...
        if 'discovery' in stage_results:
            ...
            print(f"   Discovery: {discovery['region_count']} regions, {discovery['service_count']} services")
        ...
        if 'mapping' in stage_results:
            ...
            print(f"   Mapping: {mapping['total_mappings']} service-region combinations")
        ...
        if 'transformation' in stage_results:
            ...
            expected_transforms = ['service_matrix', 'region_summary', 'service_summary', 'statistics']
        ...
        if 'analysis' in stage_results:
            ...
            expected_analyses = ['comprehensive', 'regional_distribution', 'service_coverage']
        ...
        if 'validation' in stage_results:
            ...
            print(f"   Validation: Quality score {validation['overall_quality_score']} (Grade {validation.get('data_quality_grade', 'N/A')})")
...
def test_error_handling():
    ...
    try:
        ...
        print(f"✅ Pipeline execution with broken client correctly failed: {type(e).__name__}")
