...
def test_regional_service_mapper():
    ...
    try:
        ...
        print(f"  - Coverage variance: {analysis['distribution_metrics']['coverage_variance']}")
        print(f"  - Regions with all services: {analysis['distribution_metrics']['regions_with_all_services']}")
