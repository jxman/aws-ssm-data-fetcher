...
def create_comprehensive_test_data():
    ...
    return [
        ...
        {'Region Code': 'us-east-1', 'Service Code': 'rds', 'Service Name': 'Amazon Relational Database Service'},
        {'Region Code': 'us-east-1', 'Service Code': 'dynamodb', 'Service Name': 'Amazon DynamoDB'},
        {'Region Code': 'us-east-1', 'Service Code': 'cloudwatch', 'Service Name': 'Amazon CloudWatch'},
        ...
        {'Region Code': 'us-west-2', 'Service Code': 'lambda', 'Service Name': 'AWS Lambda'},
        {'Region Code': 'us-west-2', 'Service Code': 'rds', 'Service Name': 'Amazon Relational Database Service'},
        {'Region Code': 'us-west-2', 'Service Code': 'cloudwatch', 'Service Name': 'Amazon CloudWatch'},
        
        # Europe regions
        {'Region Code': 'eu-west-1', 'Service Code': 'ec2', 'Service Name': 'Amazon Elastic Compute Cloud'},
        {'Region Code': 'eu-west-1', 'Service Code': 's3', 'Service Name': 'Amazon Simple Storage Service'},
        {'Region Code': 'eu-west-1', 'Service Code': 'lambda', 'Service Name': 'AWS Lambda'},
        {'Region Code': 'eu-west-1', 'Service Code': 'cloudwatch', 'Service Name': 'Amazon CloudWatch'},
        
        # Asia Pacific regions  
        {'Region Code': 'ap-south-1', 'Service Code': 's3', 'Service Name': 'Amazon Simple Storage Service'},
        {'Region Code': 'ap-south-1', 'Service Code': 'ec2', 'Service Name': 'Amazon Elastic Compute Cloud'},
        {'Region Code': 'ap-south-1', 'Service Code': 'cloudwatch', 'Service Name': 'Amazon CloudWatch'},
        
        # Newer regions with limited services
        {'Region Code': 'af-south-1', 'Service Code': 's3', 'Service Name': 'Amazon Simple Storage Service'},
        {'Region Code': 'af-south-1', 'Service Code': 'ec2', 'Service Name': 'Amazon Elastic Compute Cloud'},
        
        # Canada region
        {'Region Code': 'ca-central-1', 'Service Code': 'ec2', 'Service Name': 'Amazon Elastic Compute Cloud'},
        {'Region Code': 'ca-central-1', 'Service Code': 's3', 'Service Name': 'Amazon Simple Storage Service'},
        {'Region Code': 'ca-central-1', 'Service Code': 'lambda', 'Service Name': 'AWS Lambda'},
        
        # Government region
        {'Region Code': 'us-gov-west-1', 'Service Code': 'ec2', 'Service Name': 'Amazon Elastic Compute Cloud'},
        {'Region Code': 'us-gov-west-1', 'Service Code': 's3', 'Service Name': 'Amazon Simple Storage Service'}
    ]
...
def test_region_discoverer():
    ...
    context = ProcessingContext(
        ...
        logger_name="test_region_discoverer"
    )
    ...
    try:
        ...
        expected_regions = ['af-south-1', 'ap-south-1', 'ca-central-1', 'eu-west-1', 
                          'us-east-1', 'us-gov-west-1', 'us-west-2']
        ...
        # Test caching
        cached_regions = region_discoverer.process_with_cache(None)  # Pass None as input_data
...
def test_service_discoverer():
    ...
    try:
        ...
        print(f"✅ Service discovery completed: {len(discovered_services)} services found")
        print(f"   Discovered services: {discovered_services}")
        
        # Verify expected services are found
        expected_services = ['cloudwatch', 'dynamodb', 'ec2', 'iam', 'kms', 'lambda', 'rds', 's3']
        ...
        if hasattr(service_discoverer.context, 'metadata') and 'service_discovery_stats' in service_discoverer.context.metadata:
            categories = service_discoverer.context.metadata['service_discovery_stats']['service_categories']
...
def test_regional_data_validator():
    ...
    try:
        coverage_result = validator.process(
            test_data,
            validation_type="coverage_validation"
        )
    ...
    try:
        consistency_result = validator.process(
            test_data,
            validation_type="consistency_validation"
        )
    ...
    try:
        ...
        expected_regions = ['us-east-1', 'us-west-2', 'eu-west-1', 'ap-south-1', 'af-south-1', 'ca-central-1', 'us-gov-west-1']
        expected_services = ['ec2', 's3', 'lambda', 'rds', 'dynamodb', 'cloudwatch', 'iam', 'kms']
        ...
        discovery_result = validator.process(
            test_data,
            validation_type="discovery_validation"
        )
...
def test_error_handling():
    ...
    try:
        validator.process(create_comprehensive_test_data(), validation_type="invalid_validation")
